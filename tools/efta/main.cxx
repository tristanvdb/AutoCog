...
static int run(int argc, char ** argv) {
    ...
    auto sta_doc = codec::from_file<data::STA>(sta_file);
    auto fta = codec::from_file<data::FTA>(fta_file);
    autocog::types::Document frame;
    codec::from_json(codec::json_from_file_or_string(frame_arg), frame);

    data::FTT ftt = sta::encode_frame_to_ftt(*fta, *sta_doc, prompt_name, frame);
